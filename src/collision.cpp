...
// Checks for water based collisions if the flag is set. Returns false for passing between
// water tiles to a shore tile.
...
// tile. Assumes that the tileset is overworld.
